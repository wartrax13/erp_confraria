...
from .views import (
    ...
    PessoaJuridicaListView, PessoaJuridicaCreateView, PessoaJuridicaUpdateView, PessoaJuridicaDetailView
)
...
urlpatterns = [
    ...
    path('juridica/', include([
        ...
        path('detail/<int:pk>/', PessoaJuridicaDetailView.as_view(), name='pessoajuridica_detail'),
    ])),
]
